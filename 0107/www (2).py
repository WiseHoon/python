...
dealer1=[dealer[0],dealer[1]]
user2=[dealer[2],dealer[3]]
#[-200,300][-100,300][-200,-100][-100,-100]
DrawCard(dealer1[0],-200,300)
DrawCard(dealer1[1],-100,300)
DrawCard(user2[0],-200,-100)
DrawCard(user2[1],-100,-100)
...
if(pluscard.lower() =="hit"):
    ...
    print(cardrm)
    del cardm[row][col]
user2.append(dealer[4])
DrawCard(user2[2],0,-100)
